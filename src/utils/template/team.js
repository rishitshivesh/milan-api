async function TeamMailTemplate(user, event, team) {
  var template = `
  ...
  * {
  ...
  <table style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #182130;width:100%" cellpadding="0" cellspacing="0">
  <tbody>
  ...
  <p style="line-height: 140%; text-align: justify;">You have successfully registered for <strong>${event["eventName"]}.</strong></p>
  </div>
  ...
  <p style="line-height: 140%;"><strong>Team Details</strong> </p>
  </div>
  ...
  <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
  <p style="line-height: 140%;">Team Name: ${team["name"]}</p>
  <p style="line-height: 140%;">Team ID: ${team["teamId"]}</p>
  </div>
  ...
  <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
  <p style="line-height: 140%;">Wishing you and your team all the best!</p>
...
module.exports = { TeamMailTemplate };
