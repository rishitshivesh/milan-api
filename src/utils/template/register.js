async function RegisterMailTemplate(user, tempPassword) {
  ...
  * {
  ...
  <p style="line-height: 140%; text-align: justify;">You have successfully created an account on Milan '23 Website.</p>
  <p style="line-height: 140%; text-align: justify;"> </p>
  <p style="line-height: 140%; text-align: justify;">The password for your account is</p>
  <p style="line-height: 140%; text-align: justify;"> </p>
  <p style="font-size: 14px; line-height: 140%;"> </p>
  </div>
  ...
  <div align="center">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:37px; v-text-anchor:middle; width:150px;" arcsize="11%" stroke="f" fillcolor="#3AAEE0"><w:anchorlock/><center style="color:#FFFFFF;font-family:arial,helvetica,sans-serif;"><![endif]-->
  <a href="" disabled target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #3AAEE0; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
  <span style="display:block;padding:10px 20px;line-height:120%;">${tempPassword}</span>
  </a>
  ...
  <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
  <p style="line-height: 140%;">See you at the fest soon!</p>
