async function MailTemplate(user, ticket, qr) {
  ...
  * {
  ...
  <p style="line-height: 140%; text-align: justify;">You have purchased an <strong>${ticketTypes[ticket.ticketType]["name"]}</strong></p>
  <p style="line-height: 140%; text-align: justify;"> </p>
  ...
  <p style="font-size: 14px; line-height: 140%;">Ticket Type : ${ticketTypes[ticket.ticketType]["name"]}</p>
  <p style="font-size: 14px; line-height: 140%;">Ticket Price : ${ticketTypes[ticket.ticketType]["amnt"]}</p>
  <p style="font-size: 14px; line-height: 140%;">Transaction Id : ${ticket.pID}</p>
  <p style="font-size: 14px; line-height: 140%;">Ticket Purchased On : ${ticket.purchasedAt}</p>
  <p style="font-size: 14px; line-height: 140%;"> </p>
  </div>
